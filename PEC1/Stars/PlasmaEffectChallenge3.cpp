...
PlasmaEffectChallenge3::PlasmaEffectChallenge3(SDL_Surface* surface, int screenHeight, int screenWidth, int timeout, std::string title) : EffectTemplate(surface, screenHeight, screenWidth, timeout, title)
{
...
PlasmaEffectChallenge3::~PlasmaEffectChallenge3()
{
	delete[] palette;
	delete[] plasma1;
	delete[] plasma2;
...
void PlasmaEffectChallenge3::buildPalette() {
...
void PlasmaEffectChallenge3::update(float deltaTime)
{
	int currentTime = Clock::getInstance().getCurrentTime();
...
void PlasmaEffectChallenge3::render()
{
	Uint8* dst;
	long i, j;
