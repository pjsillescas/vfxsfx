...
DistortionPec1Effect::~DistortionPec1Effect()
{
	delete[] dispX;
	delete[] dispY;
...
*/
void DistortionPec1Effect::precalculate()
{
	int i, j, dst;
	dst = 0;
...
*/
void DistortionPec1Effect::Distort()
{
...
*/
void DistortionPec1Effect::Distort_Bili()
{
	// setup the offsets in the buffers
	Uint8* dst;
	int src1 = windowy1 * (screenWidth * 2) + windowx1,
