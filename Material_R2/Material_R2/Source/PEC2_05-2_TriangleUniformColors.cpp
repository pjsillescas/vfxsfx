	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				coloredShader.init("coloredUniform");
				initGL();
...
void initGL()
{
	...
	UniformIDColor = glGetUniformLocation(coloredShader.getID(), "offsetColor");
}
...
void render()
{
	...
	ColorVariation.r = sin(((SDL_GetTicks() / 20) % 360)*3.141592f / 180.0f);
	ColorVariation.g = cos(((SDL_GetTicks() / 20) % 360)*3.141592f / 180.0f);
	ColorVariation.b = 2.0f * sin(((SDL_GetTicks() / 20) % 360)*3.141592f / 180.0f);
	glUniform3f(UniformIDColor, ColorVariation.r, ColorVariation.g, ColorVariation.b);
